...
x_data <- rbind(x_train, x_test) #create X dataset

y_data <- rbind(y_train, y_test) #create Y dataset

subject_data <- rbind(subject_train, subject_test) #create Subject dataset
